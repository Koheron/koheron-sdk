...
set param [ipx::get_bus_parameters -of_objects $bus ASSOCIATED_BUSIF]
if {$param ne ""} {
  set_property VALUE {S_AXI_LITE:S_AXIS_0:S_AXIS_1:M_AXIS} $param
}

set param [ipx::get_bus_parameters -of_objects $bus ASSOCIATED_RESET]
if {$param ne ""} {
  set_property VALUE aresetn $param
}

set param [ipx::get_bus_parameters -of_objects $bus FREQ_HZ]
if {$param eq ""} {
  set param [ipx::add_bus_parameter FREQ_HZ $bus]
}
