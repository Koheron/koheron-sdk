...
cell koheron:user:adc_sample_tag:1.0 adc_sample_tag_0 {} {
  clk adc_dac/adc_clk
...
cell xilinx.com:ip:axis_dwidth_converter:1.1 axis_dwidth_converter_0 {
  ...
  s_axis_tdata adc_sample_tag_0/tagged_sample
...
# The standard DMA MM2S path remains available but does not drive the DAC.
...
# Optional DAC0 loopback tone (7.324 kHz triangle at 240 MHz DAC clock).
