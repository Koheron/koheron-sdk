    ...
    constructor(window: Window, document: Document,
        ...
        window.addEventListener('HTMLImportsLoaded', () => {
            client.init( () => {
                ...
                this.plotBasics = new PlotBasics(document, plot_placeholder, this.n_pts, this.x_min, this.x_max, this.y_min, this.y_max, this.spectrum, "setFreqRange", "Frequency (MHz)");
