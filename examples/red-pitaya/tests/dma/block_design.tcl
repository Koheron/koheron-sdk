...
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {Auto} Clk_slave {/ps_0/FCLK_CLK0 (142 MHz)} Clk_xbar {/ps_0/FCLK_CLK0 (142 MHz)} Master {/axi_dma_0/M_AXI_S2MM} Slave {/ps_0/S_AXI_GP0} ddr_seg {Auto} intc_ip {/axi_mem_intercon} master_apm {0}}  [get_bd_intf_pins axi_dma_0/M_AXI_S2MM]
