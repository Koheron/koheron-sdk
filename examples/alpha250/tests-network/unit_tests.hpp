#ifndef __ALPHA250_TESTS_NETWORK_UNIT_TESTS_HPP__
#define __ALPHA250_TESTS_NETWORK_UNIT_TESTS_HPP__
...
class Tests
{
  public:
    ...
    auto get_tuple() {
        return std::tuple{501762438, 507.3858, 926547.6468507200, true};
    }
...
#endif // __ALPHA250_TESTS_NETWORK_UNIT_TESTS_HPP__