...
freqs = np.array([5., 10.7, 21.4, 30., 40.]) * 1e6
...
for i, freq in enumerate(freqs):
    raw_input("Place {:.1f} MHz low pass filter between DAC0 and ADC0".format(freq*1e-6))
...
ax.plot(freqs*1e-6, hd2, label='HD2')
ax.plot(freqs*1e-6, hd3, label='HD3')
ax.set_xlim([0, 40])
ax.legend(loc=2)
