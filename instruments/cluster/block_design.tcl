source instruments/cluster/ports.tcl
...
# Add ADCs and DACs
source instruments/cluster/redp_adc_dac_ext_clk.tcl
...
cell pavel-demin:user:axi_cfg_register:1.0 cfg_clk {
  CFG_DATA_WIDTH 32
} {
...
connect_pins cfg_clk/cfg_data adc_dac/cfg

assign_bd_address [get_bd_addr_segs cfg_clk/s_axi/reg0]
set memory_segment [get_bd_addr_segs ps_0/Data/SEG_cfg_clk_reg0]
set_property range  [get_memory_range cfg_clk]  $memory_segment
set_property offset [get_memory_offset cfg_clk] $memory_segment
...
# SATA
source instruments/cluster/sata.tcl
add_sata sata

connect_ports sata
connect_pins sata/clk $adc_clk
connect_pins sata/dout [sts_pin sts_sata]
connect_pins sata/cfg [cfg_pin cfg_sata]
...
cell pavel-demin:user:axis_variable:1.0 phase_increment {
  ...
  cfg_data [get_concat_pin [list [cfg_pin phase_incr0] [get_slice_pin [cfg_pin phase_incr1] 15 0]]]
  aclk $adc_clk
