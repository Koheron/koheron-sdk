...
template<> int SocketSession<TCP>::init_socket() {return 0;}
template<> int SocketSession<TCP>::exit_socket() {return 0;}

template<>
int SocketSession<TCP>::read_command(Command& cmd) {
...
template<>
int SocketSession<WEBSOCK>::init_socket() {
...
template<> int SocketSession<WEBSOCK>::exit_socket() {
    return websock.exit();
}

template<>
int SocketSession<WEBSOCK>::read_command(Command& cmd) {
