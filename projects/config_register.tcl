...
proc add_config_register {module_name clk} {
  ...
  connect_pins /${::ps_name}_axi_periph/M${idx}_ARESETN /rst_${::ps_name}_125M/peripheral_aresetn
  # AXI clock converter
  ...
  connect_pins axi_clock_converter_0/s_axi_aresetn /rst_${::ps_name}_125M/peripheral_aresetn
  connect_pins axi_clock_converter_0/m_axi_aclk    /$clk
  connect_pins axi_clock_converter_0/m_axi_aresetn /rst_${::ps_name}_125M/peripheral_aresetn
  # Cfg register
  ...
  connect_pins axi_cfg_register_0/aresetn  /rst_${::ps_name}_125M/peripheral_aresetn
