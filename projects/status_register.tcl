...
proc add_status_register {module_name clk num_ports} {
  ...
  connect_bd_net [get_bd_pins /${::ps_name}_axi_periph/M${idx}_ARESETN] [get_bd_pins /${::rst_name}/peripheral_aresetn]
  # AXI clock converter
  ...
  cell xilinx.com:ip:xlconcat:2.1 concat_0 \
    [list NUM_PORTS $num_ports]            \
    [list dout axi_sts_register_0/sts_data]
