...
class Test:
    ...
    def __init__(self, client):
        ...
        self.device_memory = DeviceMemory(client)
...
driver.device_memory.add_map('config', '0x60000000', '4K')
value = 42
driver.device_memory.write32('config', 0, value)
assert(driver.device_memory.read32('config', 0) == value)