...
cp tmp/kserver/cli/kserver $root_dir/usr/local/kserver
cp tmp/kserver/cli/kserver-completion $root_dir/etc/bash_completion.d
...
# Add /usr/local/kserver to the environment PATH
cat <<- EOF_CAT > etc/environment
PATH="/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/usr/local/kserver"
EOF_CAT
