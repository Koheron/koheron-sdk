...
file delete -force tmp/cores/$core_name tmp/cores/$project_name.ip_user_files tmp/cores/$project_name.sim tmp/cores/$project_name.cache tmp/cores/$project_name.hw tmp/cores/$project_name.xpr
