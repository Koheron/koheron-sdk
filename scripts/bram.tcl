proc add_bram {bram_name bram_size} {
  ...
  set num_master_interfaces [get_property CONFIG.NUM_MI [get_bd_cells ps_0_axi_periph]]
  incr num_master_interfaces
  properties ps_0_axi_periph [list NUM_MI $num_master_interfaces]
  # Add BRAM
  ...
  apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config [list Master "/ps_0/M_AXI_GP0" Clk "Auto"] [get_bd_intf_pins axi_bram_ctrl_$bram_name/S_AXI]
  ...
  set_property range $bram_size [get_bd_addr_segs ps_0/Data/SEG_axi_bram_ctrl_${bram_name}_Mem0]
}
