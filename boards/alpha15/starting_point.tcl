...
for {set i 0} {$i < 5} {incr i} {
  create_bd_port -dir O exp_io_b34_${i}_p
  create_bd_port -dir O exp_io_b34_${i}_n
}


for {set i 0} {$i < 8} {incr i} {
  create_bd_port -dir I exp_io_b35_${i}_p
  create_bd_port -dir O exp_io_b35_${i}_n
}
