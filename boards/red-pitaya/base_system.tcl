...
connect_pins $avg_name/data_in    adc_dac/adc_0/adc_dat_a_o
connect_pins $avg_name/addr       $address_name/addr
connect_pins $avg_name/data_out   blk_mem_gen_$adc1_bram_name/dinb
connect_pins $avg_name/wen        blk_mem_gen_$adc1_bram_name/web
