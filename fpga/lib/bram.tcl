...
proc add_bram {memory_name {intercon_idx 1} {default_hexval 0}} {
  ...
  cell xilinx.com:ip:blk_mem_gen:8.3 blk_mem_gen_$memory_name {
    ...
    Write_Depth_A [get_address_depth $memory_name]
  } {}
  connect_bd_intf_net [get_bd_intf_pins axi_bram_ctrl_$memory_name/BRAM_PORTA] [get_bd_intf_pins blk_mem_gen_$memory_name/BRAM_PORTA]
  ...
  set_property offset [get_address_offset $memory_name] $memory_segment
  set_property range [get_address_range $memory_name] $memory_segment
